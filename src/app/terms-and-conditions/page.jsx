    ...
    <StyledContainer>
      <Stack p={4}>
        <Typography variant="h4" textAlign="center">
          ProperHomes Terms and Conditions
        </Typography>
        <br />
        ...
        <Typography>
          - ProperHomes reserves the right to remove or restrict any listings
        ...
        <Typography>
          - ProperHomes is not responsible for the quality, accuracy, or
          legality of property listings.
        </Typography>
        <Typography>
        ...
        <Typography>
          - ProperHomes may modify these Terms at any time. We will provide
        ...
        <Typography>
          ...
          in India and the state court choice will be ours.
        </Typography>
        <br />
        <Typography variant="h5">10. Contact Information</Typography>
        <Typography>
          If you have any questions or concerns about these Terms and
          Conditions, please contact us at support@properhomes.in.
        </Typography>
        <br />
